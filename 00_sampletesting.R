...
#save as RDS
saveRDS(followers, "processed_data/followers_kyleblaine.rds")

#combine all the saved follower dfs into one
file1 <- readRDS("processed_data/followers_kyleblaine.rds")
file2 <- readRDS("processed_data/followers_davidwright.rds")
file3 <- readRDS("processed_data/followers_davidchallian.rds")

followers <- bind_rows(file1, file2, file3)
